...
[20,1,(_1,_1loc) => { __loc = yyloc(_1loc, _1loc);
      let constName = null;
      if (_1.value === 'true') {
        constName = 1;
...
[21,1,(_1,_1loc) => { __loc = yyloc(_1loc, _1loc);
      __ = {
        type: 'Constant',
        value: Number(_1),
        raw: _1,
